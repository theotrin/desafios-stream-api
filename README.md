# Conclui todos os desafios a baixo!
## Stream API Java - Principais Métodos
## Objetivo:
Praticar e aprofundar nossos conhecimentos na poderosa Stream API do Java!<br>
...
Para todos os desafios, foi ultilizado a lista de números inteiros fornecida:
